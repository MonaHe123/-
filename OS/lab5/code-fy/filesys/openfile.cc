...
{ 
	...
	synchDisk->numThreads[fileHeaderSector]++;
    seekPosition = 0;
}
...
OpenFile::Read(char *into, int numBytes)
{
   ...
   seekPosition += result;
   hdr->SetTime(1);
   printf("The Last reading time is %s\n",hdr->GetTime(1)); //update
...
OpenFile::Write(char *into, int numBytes)
{
   ...
   hdr->SetTime(2);
   hdr->WriteBack(fileHeaderSector);
   printf("The Last writing time is %s\n",hdr->GetTime(2)); //update
   return result;
}
...
OpenFile::ReadAt(char *into, int numBytes, int position)
{
    ...
    {
        //printf("Here is OpenFile::ReadAt Error1.\n");
    ...
    if ((position + numBytes) > fileLength)
    {
        ...
        //printf("Here is OpenFile::ReadAt 2 numBytes: %d\n",numBytes);
    }
...
OpenFile::WriteAt(char *from, int numBytes, int position)
{
    ...
    {
        if(numBytes <= 0)
            printf("Here is OpenFile::WriteAt Error1: <=0.\n");
        else
            printf("Here is OpenFile::WriteAt Error1: <=fileLength.\n");
        return 0;                // check request
    }
    ...
    {
        numBytes = fileLength - position;
         printf("Here is OpenFile::WriteAt 2 numBytes: %d\n",numBytes);
    }*/
